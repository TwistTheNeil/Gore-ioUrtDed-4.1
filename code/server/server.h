...
typedef struct {
	...
	connect_t		connects[MAX_CONNECTS];
...
extern 	cvar_t 	*sv_saveSuccessMsg;
extern 	cvar_t 	*sv_loadSuccessMsg;
extern 	cvar_t 	*sv_gotoSuccessMsg;
extern 	cvar_t 	*sv_playerTeleportedMsg;
