	...
	for (i=0 ; i<sv_maxclients->integer ; i++) {
		...
		if (svs.clients[i].state >= CS_CONNECTED) {
			...
			if ( denied ) {
				...
				svs.clients[i].allowGoto = qfalse;
				svs.clients[i].allowRegainStamina = qfalse;
...
void SV_Init (void) {
	...
	sv_gotoWaitTime = Cvar_Get("sv_gotoWaitTime", "0", CVAR_ARCHIVE);
	...
	sv_gotoMsgBigtext = Cvar_Get("sv_gotoMsgBigtext", "0", CVAR_ARCHIVE);
	sv_saveSuccessMsg = Cvar_Get("sv_saveSuccessMsg", "^2Your position has been saved", CVAR_ARCHIVE);
	sv_loadSuccessMsg = Cvar_Get("sv_loadSuccessMsg", "^1Your position has been loaded", CVAR_ARCHIVE);
	sv_gotoSuccessMsg = Cvar_Get("sv_gotoSuccessMsg", "^4Goto executed successfully", CVAR_ARCHIVE);
	sv_playerTeleportedMsg = Cvar_Get("sv_playerTeleportedMsg", "^4Player teleported to your location: ^7%s", CVAR_ARCHIVE);
